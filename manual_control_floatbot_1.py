...
t2 = Relay_channel[1];   # thruster 2
t3 = Relay_channel[2];  # thruster 3
t4 = Relay_channel[3];  # thruster 4
t5 = Relay_channel[4];  # thruster 5
t6 = Relay_channel[5];   # thruster 6
t7 = Relay_channel[6];   # thruster 7
t8 = Relay_channel[7];   # thruster 8
